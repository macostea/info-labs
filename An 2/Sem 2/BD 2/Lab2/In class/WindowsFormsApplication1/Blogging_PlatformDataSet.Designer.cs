...
namespace WindowsFormsApplication1 {
    ...
    public partial class Blogging_PlatformDataSet : global::System.Data.DataSet {
        ...
        public partial class PollsDataTable : global::System.Data.TypedTableBase<PollsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PollsRow AddPollsRow(int id, string subject, string text, int authorId, System.DateTime date) {
...
namespace WindowsFormsApplication1.Blogging_PlatformDataSetTableAdapters {
    ...
    public partial class PollsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Polls] ([id], [subject], [text], [authorId], [date]) VALUES (@" +
                "id, @subject, @text, @authorId, @date);\r\nSELECT id, subject, text, authorId, dat" +
                "e FROM Polls WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Polls] SET [id] = @id, [subject] = @subject, [text] = @text, [authorId] = @authorId, [date] = @date WHERE (([id] = @Original_id) AND ([subject] = @Original_subject) AND ([text] = @Original_text) AND ([authorId] = @Original_authorId) AND ([date] = @Original_date));
SELECT id, subject, text, authorId, date FROM Polls WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication1.Properties.Settings.Default.Blogging_PlatformConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, subject, text, authorId, date FROM dbo.Polls";
        ...
        public virtual int Delete(int Original_id, string Original_subject, string Original_text, int Original_authorId, System.DateTime Original_date) {
        ...
        public virtual int Insert(int id, string subject, string text, int authorId, System.DateTime date) {
        ...
        public virtual int Update(int id, string subject, string text, int authorId, System.DateTime date, int Original_id, string Original_subject, string Original_text, int Original_authorId, System.DateTime Original_date) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string subject, string text, int authorId, System.DateTime date, int Original_id, string Original_subject, string Original_text, int Original_authorId, System.DateTime Original_date) {
            return this.Update(Original_id, subject, text, authorId, date, Original_id, Original_subject, Original_text, Original_authorId, Original_date);
        }
    }
