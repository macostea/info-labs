...
- (NSArray *)maximumSizeCliques {
    NSMutableSet *vertices = [NSMutableSet set];
    for (int it=0; it<[self numberOfVertices]; it++) {
        LGVertex *vertex = [self vertexWithData:it];
        [vertices addObject:vertex];
    }
    NSMutableArray *result = [[NSMutableArray alloc] init];
    [self bronKerbosch:[NSMutableSet set] :vertices :[NSMutableSet set] :&result];
    
    __block NSUInteger it;
    __block NSUInteger maxsize = -1;
    [result enumerateObjectsUsingBlock:^(NSMutableSet *obj, NSUInteger idx, BOOL *stop) {
...
- (void)bronKerbosch:(NSMutableSet *)res :(NSMutableSet *)p :(NSMutableSet *)x :(NSMutableArray **)result {
    if ([p count] == 0 && [x count] == 0) {
        [*result addObject:res];
        return;
    }
    for (LGVertex *vertex in [p mutableCopy]) {
        NSMutableSet *neighbours = [NSMutableSet set];
        for (LGEdge *edge in vertex.outEdges) {
            [neighbours addObject:edge.destination];
        }
        
        NSMutableSet *newP = [NSMutableSet set];
        NSMutableSet *newX = [NSMutableSet set];
        
        for (LGVertex *pVertex in p) {
            if ([neighbours containsObject:pVertex]) {
                [newP addObject:pVertex];
            }
        }
        
        for (LGVertex *xVertex in x) {
            if ([neighbours containsObject:xVertex]) {
                [newX addObject:xVertex];
            }
        }
        
        [self bronKerbosch:[[res setByAddingObject:vertex] mutableCopy] :newP :newX :result];
        
        [p removeObject:vertex];
        [x addObject:vertex];
    }
}
