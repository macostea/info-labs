...
public class ClientHandler extends Thread {
    ...
    OrdersServerEndpoint ordersServerEndpoint;
    BufferedReader br;
    PrintWriter printWriter;

    public ClientHandler(Socket socket, OrdersServerEndpoint ordersServerEndpoint) {
        this.ordersServerEndpoint = ordersServerEndpoint;
        this.socket = socket;
        running = true;
    ...
    private void sendAllOrders() {
        ArrayList<Order> orders = this.ordersServerEndpoint.persistance.getOrders();
    ...
    private void addOrder(Order o) {
        if (this.ordersServerEndpoint.persistance.addOrder(o)) {
            this.ordersServerEndpoint.sendUpdateNotification(this.ordersServerEndpoint.persistance.getOrders());
        } else {
            Packet packet = new Packet();
    ...
    private void updateOrder(Order o) {
        if (this.ordersServerEndpoint.persistance.updateOrder(o)) {
            this.ordersServerEndpoint.sendUpdateNotification(this.ordersServerEndpoint.persistance.getOrders());
        } else {
            Packet packet = new Packet();
            packet.setPacketType("error");
    ...
    private void removeOrder(Order o) {
        if (this.ordersServerEndpoint.persistance.removeOrder(o)) {
            this.ordersServerEndpoint.sendUpdateNotification(this.ordersServerEndpoint.persistance.getOrders());
        } else {
            Packet packet = new Packet();
            packet.setPacketType("error");
